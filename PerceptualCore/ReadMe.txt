...
Эта библиотека DLL PerceptualCore создана автоматически с помощью 
мастера приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения PerceptualCore.


PerceptualCore.vcxproj
...
PerceptualCore.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем PerceptualCore.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
